...
def parte1():
    ...
    with col2A:
        ...
        st.plotly_chart(figAA1, use_container_width=True)  # GRÁFICO DE BARRA HORIZONTAL
    with col3A:
        st.text("")
    with col4A:
        st.markdown(html_card_header_ABB, unsafe_allow_html=True)  # Links importantes
        st.plotly_chart(figABB, use_container_width=True)  # GRÁFICO DE BARRA HORIZONTAL
    with col5A:
        st.text("")
...
### GRAFICO AA - METRICAS GLOBAIS
    ...
    with col2A:
        ...
        st.plotly_chart(figAA, use_container_width=True)  # GRÁFICO DE BARRA HORIZONTAL
        st.markdown(html_card_header_AA2, unsafe_allow_html=True)  # Descrição Inicial
        st.plotly_chart(figAA2, use_container_width=True)  # GRÁFICO DE BARRA HORIZONTAL
    with col3A:
        st.text("")
    with col4A:
        st.markdown(html_card_header_AB, unsafe_allow_html=True)  # Links importantes
        st.plotly_chart(figAB, use_container_width=True)  # GRÁFICO DE BARRA HORIZONTAL
    with col5A:
        st.text("")
    ...
    with col2A:
        ...
        st.plotly_chart(figBA, use_container_width=True)  # GRÁFICO DE BARRA HORIZONTAL
    with col3A:
        st.text("")
    with col4A:
        st.markdown(html_card_header_BB, unsafe_allow_html=True)  # Links importantes
        st.plotly_chart(figBB, use_container_width=True)  # GRÁFICO DE BARRA HORIZONTAL
    with col5A:
        st.text("")
    ...
    with col2A:
        ...
        st.plotly_chart(figCB, use_container_width=True)  # GRÁFICO DE BARRA HORIZONTAL
    with col3A:
        st.text("")
    with col4A:
        st.markdown(html_card_header_CA, unsafe_allow_html=True)  # Descrição Inicial
        st.plotly_chart(figCA, use_container_width=True)  # GRÁFICO DE BARRA HORIZONTAL
    with col5A:
        st.text("")
