...
def brasil1():
    ...
    with col2A:
        ...
        st.plotly_chart(figA1, use_container_width=True)  # GRÁFICO DE BARRA HORIZONTAL
        st.plotly_chart(figA2, use_container_width=True)  # GRÁFICO DE BARRA HORIZONTAL
        st.plotly_chart(figA3, use_container_width=True)  # GRÁFICO DE BARRA HORIZONTAL
    with col3A:
        st.text("")
    with col4A:
        st.markdown(html_card_header_ABB, unsafe_allow_html=True)  # Links importantes
        st.plotly_chart(figA4, use_container_width=True)  # GRÁFICO DE BARRA HORIZONTAL
    with col5A:
        st.text("")
    ...
    with col2A:
        ...
        st.plotly_chart(figB1, use_container_width=True)  # GRÁFICO DE BARRA HORIZONTAL
    with col3A:
        st.text("")
    with col4A:
        st.markdown(html_card_header_BB, unsafe_allow_html=True)  # Links importantes
        st.plotly_chart(figB2, use_container_width=True)  # GRÁFICO DE BARRA HORIZONTAL
    with col5A:
        st.text("")
    ...
    with col2A:
        ...
        st.plotly_chart(figC1, use_container_width=True)  # GRÁFICO DE BARRA HORIZONTAL
    with col3A:
        st.text("")
    with col4A:
        st.markdown(html_card_header_CA, unsafe_allow_html=True)  # Descrição Inicial
        st.plotly_chart(figC2, use_container_width=True)  # GRÁFICO DE BARRA HORIZONTAL
    with col5A:
        st.text("")
